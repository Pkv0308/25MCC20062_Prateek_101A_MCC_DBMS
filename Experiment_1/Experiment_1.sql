...
INSERT INTO DEPARTMENT VALUES (1, 'Sales'), (2, 'Marketing'), (3, 'Legal'), (4, 'IT'), (5, 'Accounts'), (6, 'HR');
...
INSERT INTO Employee (emp_id, emp_name, dept_id, proj_id) VALUES
...
UPDATE EMPLOYEE SET PROJ_ID = 6000 WHERE PROJ_ID = 6001;

DELETE FROM PROJECT WHERE DEPT_ID = 3;
...
-- explicitly revoking create privilege on db

REVOKE CREATE ON SCHEMA "Experiment_1" FROM REPORTER;
...
--check if project table has been succesfully dropped
select * from project;
